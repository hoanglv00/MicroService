...
function setUrlForCompare(req) {
    var yearAndMonth = req.query.year + req.query.month;
    var endOfMonth = moment(req.query.year + req.query.month, "YYYYMM").daysInMonth()
    var params = {
...
function compareKPIEmployeeByMonth(req, res, next) {
...
function getListKPIEmployeeByMonth(req, res, next) {
...
module.exports = {
    compareKPIEmployeeByMonth: compareKPIEmployeeByMonth,
    getListKPIEmployeeByMonth: getListKPIEmployeeByMonth
}
