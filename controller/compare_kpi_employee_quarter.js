...
function setUrlForCompare(req) {
    switch(req.query.quarter) {
        case '01':
            ...
            var yearAndMonthEnd = req.query.year + '03';
            break;
        case '02':
            var yearAndMonthStart = req.query.year + '04';
            var yearAndMonthEnd = req.query.year + '06';
            break;
        case '03':
            var yearAndMonthStart = req.query.year + '07';
            var yearAndMonthEnd = req.query.year + '09';
            break;
        case '04':
            var yearAndMonthStart = req.query.year + '10';
...
function compareKPIEmployeeByQuarter(req, res, next) {
...
function getListKPIEmployeeByQuarter(req, res, next) {
...
module.exports = {
    compareKPIEmployeeByQuarter: compareKPIEmployeeByQuarter,
    getListKPIEmployeeByQuarter: getListKPIEmployeeByQuarter
}
